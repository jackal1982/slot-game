...
DragonWolf.Config = {
    ...
    // Free Game 賠率表（M1 增量後降低補償，Total RTP ~96.4%）
    FREE_PAY: {
        M1: { 3: 0.22, 4: 0.56, 5: 1.10 },
        M4: { 3: 0.10, 4: 0.22, 5: 0.42 },
        A1: { 3: 0.04, 4: 0.12, 5: 0.24 },
        A2: { 3: 0.04, 4: 0.10, 5: 0.14 },
        A3: { 3: 0.04, 4: 0.10, 5: 0.14 },
        A4: { 3: 0.04, 4: 0.04, 5: 0.12 }
    },
    ...
    FREE_REEL_CONFIGS: [
        { SC:2,      M1:10, M4:5, A1:14, A2:17, A3:24, A4:38 }, // 軸1 (110)
